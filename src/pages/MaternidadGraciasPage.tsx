...
const MaternidadGraciasPage: React.FC = () => {
  return (
    <div style={s.page}>
      <div style={s.bg}>
      ...
      <div style={s.container}>
        ...
        >
          ...
          <p style={s.upgradeBody}>
            ...
            una <strong>sesión personal conmigo</strong>, enfocada en tu maternidad y la carta de tu hijo.
          </p>
        ...
        >
          ...
          <div style={s.iframeWrapper}>
            <iframe
              ...
              height="600"
              frameBorder="0"
              title="Agendar sesión de Astrología para Maternidad"
            />
          </div>
        </motion.div>
...
const s: Record<string, React.CSSProperties> = {
  ...
  upgradeCard: {
    ...
    padding: '32px',
    width: '100%',
    boxShadow: '0 12px 32px rgba(128,43,72,0.09)',
    display: 'flex',
    flexDirection: 'column',
    gap: '20px',
  },
  ...
  valueRow: {
    ...
    alignItems: 'center',
    gap: '16px',
    background: 'rgba(128,43,72,0.05)',
    borderRadius: '14px',
    padding: '18px 24px',
  },
  valuePaid: {
...
export default MaternidadGraciasPage;
